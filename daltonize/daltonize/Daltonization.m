...
%           printf('XYZ to LMS: %s\r\n', type);
        ...
        function daltonize(image_path, xyz_transformation, lms_transformation)
          ...
          if all(size(sizeRGB) ~= 3) || all(sizeRGB(3) ~= 3)
            disp('The image should be colorized RGB');
            return;
          end
          ...
          rgb2xyz = Daltonization.get_rgb2xyz_matrix(xyz_transformation);
          xyz2lms = Daltonization.get_xyz2lms_matrix(lms_transformation);
          ...
          tic
          RGB_p = Daltonization.get_colorblind_image(RGB, rgb2lms, lms2lms_p);
          RGB_d = Daltonization.get_colorblind_image(RGB, rgb2lms, lms2lms_d);
          RGB_t = Daltonization.get_colorblind_image(RGB, rgb2lms, lms2lms_t);
          toc
